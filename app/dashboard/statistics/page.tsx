...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-purple-50/40 relative overflow-hidden mt-20">
            ...
            {companies.length > 1 ? (
              ...
              >
                <Select
                  ...
                  onValueChange={setSelectedCompanyId}
                >
                  <SelectTrigger className="w-[300px] h-14 border-2 border-slate-200 bg-white/90 backdrop-blur-xl focus:ring-2 focus:ring-indigo-500/40 focus:border-indigo-400 hover:border-indigo-300 hover:shadow-lg transition-all duration-300 shadow-md rounded-2xl font-semibold">
                    <SelectValue placeholder="Select a company" />
                  </SelectTrigger>
                  <SelectContent className="bg-white/95 backdrop-blur-xl shadow-2xl border-2 border-slate-200 rounded-2xl">
                    {companies.map((company) => (
                      <SelectItem
                        key={company._id}
                        value={company._id}
                        className="hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-500 focus:bg-gradient-to-r focus:from-indigo-500 focus:to-purple-500 transition-all duration-200 cursor-pointer rounded-xl my-1 font-medium text-black"
                      >
                        {company.name}
                      </SelectItem>
                    ))}
              ...
              <motion.div
                key="single-company"
                className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-white/90 to-indigo-50/80 backdrop-blur-xl rounded-2xl shadow-lg border-2 border-indigo-200/50"
                initial={{ opacity: 0, x: 20, scale: 0.9 }}
                animate={{ opacity: 1, x: 0, scale: 1 }}
                exit={{ opacity: 0, x: -20, scale: 0.9 }}
              ...
              <motion.p
                key="no-company"
                className="text-lg text-slate-600 italic font-medium"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: -20 }}
                transition={{ duration: 0.5 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                <Card className="border-0 shadow-2xl bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-xl hover:shadow-3xl transition-all duration-500 overflow-hidden group">
                  ...
                  <CardHeader className="border-b border-slate-100/50 bg-gradient-to-r from-slate-50/50 to-indigo-50/30 pb-5 relative">
                    <div className="flex items-center gap-3">
                      <motion.div
              ...
              >
                <Card className="border-0 shadow-2xl bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-xl hover:shadow-3xl transition-all duration-500 overflow-hidden group">
                  ...
                  <CardHeader className="border-b border-slate-100/50 bg-gradient-to-r from-slate-50/50 to-purple-50/30 pb-5 relative">
                    <div className="flex items-center gap-3">
                      <motion.div
              ...
              >
                <Card className="border-0 shadow-2xl bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-xl hover:shadow-3xl transition-all duration-500 overflow-hidden group">
                  ...
                  <CardHeader className="border-b border-slate-100/50 bg-gradient-to-r from-slate-50/50 to-pink-50/30 pb-5 relative">
                    <div className="flex items-center gap-3">
                      <motion.div
